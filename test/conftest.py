...
async def testapp(_mock_kafka_producer: MockKafkaProducer,
                  ...
                  _mock_pg_pool: MockPgPool) -> AsyncApp:
...
@pytest.fixture(scope='function')
async def api_client(_mocking: Mocking, testapp: AsyncApp) -> AsyncClient:
