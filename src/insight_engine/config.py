...
from insight_engine.util.paths import repository_path, app_name
...
class AppConfig(Serializable):
    ...
    # 🟡 OPTIONAL / DEFAULT FIELDS (ALWAYS LAST)
    cached_table_freshness_check_interval_seconds: int = 10
    cached_table_refresh_interval_min_seconds: int = 30
    cached_table_refresh_interval_max_seconds: int = 600
    cached_hash_retention_seconds: int = 43200
    cached_hash_freshness_check_interval_seconds: int = 3600
