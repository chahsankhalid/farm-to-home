...
from insight_engine.accesscontrol.authorization import authorize
from insight_engine.domain import api_info
from insight_engine.domain.models.health_status import HealthStatus
from insight_engine.domain.models.message import Message
from insight_engine.util.exceptions import DuplicateValueException
...
@authorize()
async def welcome():
    msg = f'Welcome to Fraudio! This is the {app_name()} API.'
    return Message(msg)
